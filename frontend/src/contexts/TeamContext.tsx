...
export const TeamProvider: React.FC<TeamProviderProps> = ({ children }) => {
    ...
    const fetchTeamData = async () => {
        try {
            ...
            const res = await fetch(`https://teamup-server-beryl.vercel.app/api/teams/${team_id}`, {
                credentials: 'include',
            });
    ...
    const updateTeamName = async (newName: string) => {
        ...
        try {
            const res = await fetch(`https://teamup-server-beryl.vercel.app/api/teams/${teamInfo.team_id}/name`, {
                method: "PUT",
    ...
    const deleteTeam = async () => {
        ...
        try {
            const res = await fetch(`https://teamup-server-beryl.vercel.appapi/teams/${teamInfo.team_id}`, {
                method: "DELETE",
                credentials: "include",
            });
    ...
    const leaveTeam = async () => {
        ...
        try {
            const res = await fetch(`https://teamup-server-beryl.vercel.app/api/teams/${teamInfo.team_id}/leave`, {
                method: "DELETE",
                credentials: "include",
            });
